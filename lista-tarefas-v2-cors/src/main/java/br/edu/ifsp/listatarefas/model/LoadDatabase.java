...
public class LoadDatabase {
    ...
    CommandLineRunner initDataBase(ListaRepository repository){
        return args ->{
           ...
           Lista lista1 = new Lista("Contas a pagar", "Compras", "Lista de todas as contas que devo pagar");
           ...
           Lista lista2 = new Lista("Provas do IFSP", "Escola", "Lista de todas as provas desse semestre");
